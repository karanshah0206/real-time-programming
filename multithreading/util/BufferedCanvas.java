...
public abstract class BufferedCanvas extends Canvas {
    public static final boolean USE_BUFFERING = !System.getProperty("os.name").startsWith("Mac OS");

    public static boolean fUseBufferedImage = false;

    public static boolean isBuffering() {
        return USE_BUFFERING;
    }
